...
var dappAddress = "n1u3xHbYDQUuvEDCA5KzFEDDKZ6qeMMX3q3";
...
if (env == 'testnet') {
    dappAddress = 'n1u3xHbYDQUuvEDCA5KzFEDDKZ6qeMMX3q3';
    nebulasUrl = 'https://testnet.nebulas.io';
    payCallbackUrl = NebPay.config.testnetUrl;
}
...
$().ready(function () {
    ...
    $(".data-icon").click(function () {
        ...
        msg += '<p>4. 总计分红包含累积分红、中奖分红以及邀请分红三者总和</p>'
        msg += '<p></p>'
        showDialog(tip, msg)
    })
