...
// }
var dappAddress = "n1eYfJCBhAMes6DxzPVNRWecJfSLbXry9Gd";
...
$().ready(function () {
    ...
    if (typeof (webExtensionWallet) === "undefined") {
        ...
        $(".message").text("Extension wallet is not installed, please install it first.");
        $("#exit").click(function () {
            $("#msg").addClass("hide");
        })
        ...
        .then(function (resp) {
            ...
            if (respObject.code === 0 && respObject.data.status !== 2) {
                ...
                if (respObject.data.status === 1) {
                    ...
                    // alert(" successfully! you bought " + execute_result.amount + " keys, each " + execute_result.price / 1000000000000000000 + " nas");

                    // 提示信息
                    $("#biaoti").text("dsdsdsd");
                    $("#msg").removeClass("hide");
                    $(".message").html("successfully! you bought " + execute_result.amount + " keys, each" + execute_result.price / 1000000000000000000 + " nas");
                    $("#exit").click(function () {
                        $("#msg").addClass("hide");
                    })
                    ...
                    // 提示信息
                    $("#biaoti").text("dsdsssssssssssssssdsd");
                    $("#msg").removeClass("hide");
                    $(".message").text(srespObject.data.execute_error);
                    $("#exit").click(function () {
                        $("#msg").addClass("hide");
                    })
