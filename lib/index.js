...
var dappAddress = "n1iVaWL7ehfw68QpEPq5Dfwq8MZ1YJfM29z";
...
$().ready(function () {
    ...
    setTimeout(function(){
        ...
        if (typeof (webExtensionWallet) === "undefined") {
            ...
            $(".message").html("转化兽是基于星云链的一款应用，需要依赖星云chrome钱包插件，安装地址:<a target='_blank' href='https://chrome.google.com/webstore/detail/nasextwallet/gehjkhmhclgnkkhpfamakecfgakkfkco'>Chrome Web Store</a>");
        ...
        .then(function (resp) {
            ...
            if (respObject.code === 0 && respObject.data.status !== 2) {
                ...
                if (respObject.data.status === 1) {
                    ...
                    $("#title").text("温馨提示");
                    $("#msg").removeClass("hide");
                    $(".message").text('合约调用失败:'+respObject.data.execute_error);                
                }
            }else{
                $("#title").text("温馨提示");
                $("#msg").removeClass("hide");
