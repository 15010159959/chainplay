...
var dappAddress = "n1x5WHMVcFt7LwfqAECN2ZqctoX8tkzSjZX";
...
if (env == 'testnet') {
    dappAddress = 'n1x5WHMVcFt7LwfqAECN2ZqctoX8tkzSjZX';
    nebulasUrl = 'https://testnet.nebulas.io';
    payCallbackUrl = NebPay.config.testnetUrl;
}
                ...
                if (respObject.code === 0 && respObject.data.status !== 2) {
                    ...
                    if (respObject.data.status === 1) {
                        ...
                        if (callFunction == "buyKey") {
                            ...
                            if (execute_result.egg) {
                                msg = "<p>哇塞！你不仅购买成功了，你还中奖了</p>";
                                msg += "恭喜你,你将获得" + execute_result.egg / 1000000000000000000 + " nas,别忘记了领奖和分享给朋友哦"
